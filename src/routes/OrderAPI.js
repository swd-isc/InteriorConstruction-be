...
const OrderRouter = (app) => {
  ...
  // router.post("/", verifyToken, orderService.createOrder); //Unused

  // router.put("/:id", verifyToken, orderService.updateOrder); //Unused

  // router.delete("/:id", verifyToken, orderService.deleteOrder); //Unused
